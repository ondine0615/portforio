...
run_shell=subprocess.check_output("/home/ondine0615/workplace/chat-log/data/TwitchDownloaderCLI -m ChatDownload --id {} --timestamp-format Relative -o {}.txt".format(_id,broad_day),shell=True)